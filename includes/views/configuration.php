...
<div class="wrap">
    ...
    <form method="post">
        ...
        <div class="form-field" style="margin-top: 20px;">
            <label for="google_api_download_url"><strong>Url del archivo de Google Api Client [<a target="_blank" href="https://github.com/googleapis/google-api-php-client/releases">Ver repositorio</a>]</strong></label><br>
