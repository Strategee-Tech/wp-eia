async function geminiPost(imageUrl) {
    ...
    // Asegúrate de que la salida sea un objeto JSON **estrictamente válido** y nada más. siempre responde en español, no describamos tan detalladamente a las personas, nos enfocamos mas en el contexto educativo`.trim(); 


    // const base64Image = await imageUrlToBase64(imageUrl);

    // const imageExtension = imageUrl.split('.').pop().toLowerCase();
    // let imageMimeType = 'image/jpeg'; // Valor por defecto
    // if (imageExtension === 'png') {
    //     imageMimeType = 'image/png';
    // } else if (imageExtension === 'webp') {
    //     imageMimeType = 'image/webp';
    // } else if (imageExtension === 'gif') {
    //     imageMimeType = 'image/gif'; // Añadido soporte para GIF
    // }
    ...
    // const response = await fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-lite-preview-06-17:generateContent?key=AIzaSyCgo9gEgPrCp_81LGuxLh5rpEgdWCkmeBA', {
    //     method: 'POST',
    //     headers: {
    //         'Content-Type': 'application/json',
    //     },
