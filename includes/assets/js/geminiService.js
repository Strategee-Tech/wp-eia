async function geminiPost(imageUrl) {
    ...
    const response = await fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-pro:generateContent?key=AIzaSyCgo9gEgPrCp_81LGuxLh5rpEgdWCkmeBA', {
        method: 'POST',
        headers: {
